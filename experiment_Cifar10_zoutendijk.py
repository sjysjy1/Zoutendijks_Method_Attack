...
{'model':'Standard','attack':'Z_linf_M2','epsilon':8.0/255 ,'stepsize':0.007,'iter_max':20,'div':5.0,'beta':0.3,'rho': 0.9,'batch_size':batch_size,'early_stop':False},
{'model':'Standard','attack':'Z_linf_M2','epsilon':16.0/255,'stepsize':0.007,'iter_max':20,'div':5.0,'beta':0.3,'rho': 0.9,'batch_size':batch_size,'early_stop':False},
{'model':'Standard','attack':'Z_linf_M2','epsilon':32.0/255,'stepsize':0.007,'iter_max':20,'div':5.0,'beta':0.3,'rho': 0.9,'batch_size':batch_size,'early_stop':False},
...
{'model':'Wong2020Fast','attack':'Z_linf_M1','epsilon':8.0/255 ,'stepsize':0.007,'iter_max':20,'batch_size':batch_size,'div':1.0, 'beta':0.3,'rho': 0.99,'early_stop':False},
{'model':'Wong2020Fast','attack':'Z_linf_M1','epsilon':16.0/255,'stepsize':0.007,'iter_max':20,'batch_size':batch_size,'div':1.0,'beta':0.3,'rho': 0.99,'early_stop':False},
{'model':'Wong2020Fast','attack':'Z_linf_M1','epsilon':32.0/255,'stepsize':0.007,'iter_max':20,'batch_size':batch_size,'div':1.0,'beta':0.3,'rho': 0.99,'early_stop':False},
{'model':'Wong2020Fast','attack':'Z_linf_M2','epsilon':8.0/255 ,'stepsize':0.007,'iter_max':20,'div':1.0,'beta':0.3,'rho': 0.99,'batch_size':batch_size,'early_stop':False},
{'model':'Wong2020Fast','attack':'Z_linf_M2','epsilon':16.0/255,'stepsize':0.007,'iter_max':20,'div':1.0,'beta':0.3,'rho': 0.99,'batch_size':batch_size,'early_stop':False},
{'model':'Wong2020Fast','attack':'Z_linf_M2','epsilon':32.0/255,'stepsize':0.007,'iter_max':20,'div':1.0,'beta':0.3,'rho': 0.99,'batch_size':batch_size,'early_stop':False},
...
{'model':'Wang2023Better','attack':'Z_linf_M1','epsilon':8.0/255 ,'stepsize':0.007,'iter_max':20,'batch_size':batch_size,'div':1.0, 'beta':0.3,'rho': 0.99,'early_stop':False},
{'model':'Wang2023Better','attack':'Z_linf_M1','epsilon':16.0/255,'stepsize':0.007,'iter_max':20,'batch_size':batch_size,'div':1.0,'beta':0.3,'rho': 0.99,'early_stop':False},
{'model':'Wang2023Better','attack':'Z_linf_M1','epsilon':32.0/255,'stepsize':0.007,'iter_max':20,'batch_size':batch_size,'div':1.0,'beta':0.3,'rho': 0.99,'early_stop':False},
{'model':'Wang2023Better','attack':'Z_linf_M2','epsilon':8.0/255 ,'stepsize':0.007,'iter_max':20,'div':1.0,'beta':0.3,'rho': 0.99,'early_stop':False,'batch_size':batch_size,'early_stop':False},
{'model':'Wang2023Better','attack':'Z_linf_M2','epsilon':16.0/255,'stepsize':0.007,'iter_max':20,'div':1.0,'beta':0.3,'rho': 0.99,'early_stop':False,'batch_size':batch_size,'early_stop':False},
{'model':'Wang2023Better','attack':'Z_linf_M2','epsilon':32.0/255,'stepsize':0.007,'iter_max':20,'div':1.0,'beta':0.3,'rho': 0.99,'early_stop':False,'batch_size':batch_size,'early_stop':False},
{'model':'Wang2023Better','attack':'Z_linf_M1','epsilon':8.0/255 ,'stepsize':0.007,'iter_max':20,'batch_size':batch_size,'beta':0.3,'rho': 0.99,'early_stop':False},
{'model':'Wang2023Better','attack':'Z_linf_M1','epsilon':16.0/255,'stepsize':0.007,'iter_max':20,'batch_size':batch_size,'beta':0.3,'rho': 0.99,'early_stop':False},
{'model':'Wang2023Better','attack':'Z_linf_M1','epsilon':32.0/255,'stepsize':0.007,'iter_max':20,'batch_size':batch_size,'beta':0.3,'rho': 0.99,'early_stop':False},
{'model':'Wang2023Better','attack':'Z_linf_M2','epsilon':8.0/255 ,'iter_max':20,'div':2.0,'batch_size':batch_size,'early_stop':False},
{'model':'Wang2023Better','attack':'Z_linf_M2','epsilon':16.0/255,'iter_max':20,'div':2.0,'batch_size':batch_size,'early_stop':False},
{'model':'Wang2023Better','attack':'Z_linf_M2','epsilon':32.0/255,'iter_max':20,'div':2.0,'batch_size':batch_size,'early_stop':False},
{'model':'Wang2023Better','attack':'MIFGSM','epsilon':8.0/255 ,'stepsize':0.007,'decay':0.3,'iter_max':20,'batch_size':batch_size},
{'model':'Wang2023Better','attack':'MIFGSM','epsilon':16.0/255,'stepsize':0.007,'decay':0.3,'iter_max':20,'batch_size':batch_size},
{'model':'Wang2023Better','attack':'MIFGSM','epsilon':32.0/255,'stepsize':0.007,'decay':0.3,'iter_max':20,'batch_size':batch_size},
{'model':'Wang2023Better','attack':'NIFGSM','epsilon':8.0/255 ,'stepsize':0.007,'decay':0.3,'iter_max':20,'batch_size':batch_size},
{'model':'Wang2023Better','attack':'NIFGSM','epsilon':16.0/255,'stepsize':0.007,'decay':0.3,'iter_max':20,'batch_size':batch_size},
{'model':'Wang2023Better','attack':'NIFGSM','epsilon':32.0/255,'stepsize':0.007,'decay':0.3,'iter_max':20,'batch_size':batch_size},
{'model':'Wang2023Better','attack':'PGD','epsilon':8.0/255 ,'stepsize':0.01,'iter_max':20,'batch_size':batch_size,'norm':'Linf'},
{'model':'Wang2023Better','attack':'PGD','epsilon':16.0/255,'stepsize':0.01,'iter_max':20,'batch_size':batch_size,'norm':'Linf'},
{'model':'Wang2023Better','attack':'PGD','epsilon':32.0/255,'stepsize':0.01,'iter_max':20,'batch_size':batch_size,'norm':'Linf'},
{'model':'Wang2023Better','attack':'BIM','epsilon':8.0/255 ,'stepsize':0.01,'iter_max':20,'batch_size':batch_size},
{'model':'Wang2023Better','attack':'BIM','epsilon':16.0/255,'stepsize':0.01,'iter_max':20,'batch_size':batch_size},
{'model':'Wang2023Better','attack':'BIM','epsilon':32.0/255,'stepsize':0.01,'iter_max':20,'batch_size':batch_size},
...
for item in list_para:
    ...
    elif item['model'] == 'Wang2023Better':
    ...
    #            plt.subplot(330 + 1 + i)
    #            # plot raw pixel data
    #            plt.imshow(images[i].cpu(), cmap=plt.get_cmap('gray'))
    #        # show the figure
    #        plt.show()
...
#
    ...
    if item['attack']=='Z_linf_M1':
        torch.save(dict_save,'./result/cifar10/{}_{}_epsilon{}_stepsize{}_div{}_beta{}_rho{}_iter{}_es{}.pt'.format(item['model'],item['attack'],item['epsilon'],item['stepsize'],item['div'],item['beta'],item['rho'],item['iter_max'],item['early_stop']))
    elif item['attack']=='Z_linf_M2':
        torch.save(dict_save,'./result/cifar10/{}_{}_epsilon{}_stepsize{}_div{}_beta{}_rho{}_iter{}_es{}.pt'.format(item['model'],item['attack'],item['epsilon'],item['stepsize'],item['div'],item['beta'],item['rho'],item['iter_max'],item['early_stop']))
    elif item['attack']=='PGD':
       torch.save(dict_save,'./result/cifar10/{}_attack_{}_epsilon{}_iter{}.pt'.format(item['model'], item['attack'], item['epsilon'],item['iter_max']))
    elif item['attack']=='MIFGSM':
        torch.save(dict_save,'./result/cifar10/{}_attack_{}_epsilon{}_iter{}.pt'.format(item['model'], item['attack'], item['epsilon'],item['iter_max']))
    elif item['attack']=='NIFGSM':
        torch.save(dict_save,'./result/cifar10/{}_attack_{}_epsilon{}_iter{}_decay{}.pt'.format(item['model'], item['attack'], item['epsilon'],item['iter_max'],item['decay']))
    elif item['attack']=='BIM':
        torch.save(dict_save,'./result/cifar10/{}_attack_{}_epsilon{}_iter{}.pt'.format(item['model'], item['attack'], item['epsilon'],item['iter_max']))
