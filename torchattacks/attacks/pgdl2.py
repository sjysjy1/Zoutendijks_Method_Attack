...
class PGDL2(Attack):
    ...
    def forward(self, images, labels):
        ...
        success = False  # sunijyuan
        num=0 #sunjiyuan
        for _ in range(self.steps):
            num = num + 1  # sunijyuan
            print('iter=',num)#sunijyuan
            ...
            _,predict_label=torch.max(self.model(adv_images), 1)#sunjiyuan
            print('cost is:',cost)#sunjiyuan
            if predict_label!=labels:#sunijyuan
                success=True#sunijyuan
                break#sunijyuan
        return adv_images,delta,num,success,cost
